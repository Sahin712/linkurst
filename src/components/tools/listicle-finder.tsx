...
export function ListicleFinder() {
  ...
  return (
    <div className="mt-10">
      <form
        onSubmit={openModal}
        className="rounded-[var(--radius-xl)] border border-coral/20 bg-gradient-to-br from-coral-wash/70 via-surface to-coral-wash/30 p-6 shadow-[var(--shadow-panel)] sm:p-8"
      >
