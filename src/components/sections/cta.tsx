...
/**
 * Closing CTA — a highlighted, contained dark panel that stands off the page:
 * coral-tinted glow, centered roman + serif-italic headline, one clear action.
 * `CtaPanel` is the reusable box (also dropped into the AEO tool's report);
 * `Cta` wraps it in a full section for page-level use.
 */
