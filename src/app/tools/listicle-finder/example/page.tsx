...
const EXAMPLE: FindResult = {
  ...
  listicles: [
    ...
    { title: "Affordable CRM Software Options", url: "https://budgetsaas.com/crm", domain: "budgetsaas.com", da: 44, pa: 27, traffic: 8400, updated: "2025-08-14", bestPosition: 14, appearances: 1, mentionsBrand: false, competitorsMentioned: [] },
    { title: "Enterprise CRM Platforms Reviewed", url: "https://enterprisetech.com/crm", domain: "enterprisetech.com", da: 79, pa: 52, traffic: 118000, updated: "2026-06-05", bestPosition: 15, appearances: 1, mentionsBrand: false, competitorsMentioned: [] },
  ],
};
